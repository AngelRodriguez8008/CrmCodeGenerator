...
// TODO this was taken from XrmToolBox, but will it work with the standard DeviceIdManager from Microsoft???  I think it  will
    ...
    public static class DeviceIdManager
    {
        ...
        private static DeviceUserName GenerateDeviceUserName()
        {
            ...
            {
                DeviceName = GenerateRandomString(LiveIdConstants.ValidDeviceNameCharacters, LiveIdConstants.DeviceNameLength),
                DecryptedPassword = GenerateRandomString(LiveIdConstants.ValidDevicePasswordCharacters, LiveIdConstants.DevicePasswordLength)
            };
    ...
    public sealed class DeviceUserName
    {
        ...
        public string DeviceId => UserNamePrefix + DeviceName;
